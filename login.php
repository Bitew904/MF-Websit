...
<?php
	...
	//Checking is user existing in the database or not
        ...
        if($rows==1){
			...
			header("Location: Admin/home.php"); // Redirect user to Admin.php
			...
			header("Location: Employee/Home.php"); // Redirect user to Employee.php
			 }else if($data['role']=="HR"){
				 $_SESSION['user_id'] = $data['ID'];
				$_SESSION['user_name'] = $data['name'];
				$_SESSION['user_role'] = $data['Role'];

			header("Location: HR/home.php"); // Redirect user to Employee.php
