...
if(mysqli_query($conn, "INSERT INTO users(Role, Fname, phone, username, email ,password) VALUES('" . $role . "','" . $fname . "','" . $name . "','" . $phone . "', '" . $email . "', '" . md5($password) . "')")) {
header("location: register.php");
$sucessmsage="Succesfully Added";
exit();
} else {
	...
	<div class="row">
		<div class="col-md-4 col-md-offset-4 well">
			<form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="signupform">
				<fieldset>
					<legend>Sign Up  <span class="text-danger"><?php if (isset($sucessmsage)) echo $sucessmsage; ?></span></legend>
					...
					<div class="form-group">
						<label for="name">Phone</label>
                           <input type="text" name="phone" class="form-control" value="" maxlength="50" required="">
