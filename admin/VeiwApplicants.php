        ...
        ?>
         ...
         <tbody class="table-bordered">
            <tr>
               ...
               <td colspan="">
                  <a href="updatecustomer.php?ID=<?php echo $result["ID"]; ?>" type="submit"
                     class="btn btn-primary"><i class="fas fa-pencil-alt"></i> Edit</a>
                  <a href="app/deletecustomer.php?ID=<?php echo $result["ID"]; ?>"
                     type="submit" class="btn btn-danger"><i class="fas fa-trash"></i> Delete</a>
                  <a href="pdf_singlecustomer.php?ID=<?php echo $result['ID']; ?>"
