...
<li><a href="addbid.php">Announce Bid</a></li>
...
<form id="form1" method="post" action="Insertpf.php">
<fieldset>
					<legend>Add Vacancy </legend>
					<div class="form-group">
						<label for="name">Add Number of Customer</label>
                           <input type="text" name="cutno" class="form-control" value="" maxlength="50" required="">
                          <span class="text-danger"><?php if (isset($error)) echo $error; ?></span>
					</div>
					<div class="form-group">
						<label for="name">Add Number of Branch</label>
                           <input type="text" name="cutbr" class="form-control" value="" maxlength="50" required="">
                          <span class="text-danger"><?php if (isset($error)) echo $error; ?></span>
					</div>
					<div class="form-group">
						<label for="name">Add Number of Agents</label>
                           <input type="text" name="cutag" class="form-control" value="" maxlength="50" required="">
                          <span class="text-danger"><?php if (isset($error)) echo $error; ?></span>
					</div>
					
					<div class="form-group">
						<label for="name">Add Number of Asset</label>
                           <input type="text" name="cutas" class="form-control" value="" maxlength="50" required="">
                          <span class="text-danger"><?php if (isset($error)) echo $error; ?></span>
					</div>
