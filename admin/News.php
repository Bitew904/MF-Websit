...
<fieldset>
					...
					<div class="form-group">
						<label for="name">Tetle</label>
                           <input type="text" name="posttitle" class="form-control" value="" maxlength="100" required="">
                          <span class="text-danger"><?php if (isset($error)) echo $error; ?></span>
					</div>
					<div class="form-group">
						<label for="name">one line describtion about news</label>
                           <textarea name="Discription" class="form-control" value=""  required="" cols="25" rows="5"></textarea>
                          <span class="text-danger"><?php if (isset($error)) echo $error; ?></span>
					</div>
					<div class="form-group">
						<label for="name">News Details</label>
                           <textarea name="postdescription" class="form-control" value=""  required="" cols="25" rows="10"></textarea>
                          <span class="text-danger"><?php if (isset($error)) echo $error; ?></span>
					</div>
					
					<div class="form-group">
						<label for="name">Images About news</label>
