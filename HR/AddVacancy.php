...
<li><a href="Events.php">Veiw Applicant</a></li>
<li><a href="Vacancy.php">Add Vacancy</a></li>
...
<fieldset>
					...
					<div class="form-group">
						<label for="name">Job_ID</label>
                           <input type="text" name="Jobid" class="form-control" value="" maxlength="50" required="">
                          <span class="text-danger"><?php if (isset($name_error)) echo $name_error; ?></span>
					</div>
					<div class="form-group">
						<label for="name">Department</label>
                           <input type="text" name="Department" class="form-control" value="" maxlength="50" required="">
                          <span class="text-danger"><?php if (isset($name_error)) echo $name_error; ?></span>
					</div>
                   ...
                   <input type="text" name="totalv" class="form-control" value="" maxlength="50" required="">
             
                      </div>
					
                     <div class="form-group">
                   <label>Qualification</label>
                   <select name="cmbQual" class="form-control">
                            <option  value="Doctrate">Doctor and Above</option>
                            ...
                            <option value="Diploma">Diploma and Above</option>
                   ...
                   <label>Job Discription</label>
				    ...
				    <textarea name="Discription" class="form-control" value="" maxlength="50" required="" cols="25" rows="3"></textarea>
