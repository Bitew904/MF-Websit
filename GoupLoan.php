...
<center>
<h1>Goup Loan for youth & Women Enterprineurs</h1>

		<img src="img/fent.jpg">
		<p>Enterprise Partners (EP), a seven-year (2013- 2020) multi-sector programme funded by the United Kingdom’s Foreign, Commonwealth Development Office (formerly DFID) aims to facilitate market systems development in order to create jobs and raise incomes of Ethiopians, especially women, living in poverty. The programme employed a combination of Technical Assistance (TA) and market facilitation to resolve market failures and spur innovation and investment by applying the Making Markets Work for the Poor (M4P) approach for sustainable results. The programme has been at the forefront of addressing core market system failures to increase lending between financial institutions and client firms over the past seven years. It managed numerous interventions that evolved over time and built on one another to drive broader changes in the financial system.</p>
