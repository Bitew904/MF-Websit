...
<div class="overview">
<h1>overview</h1>
<p>Established in 2005(G.C.) and Affiliated to facilitator for Change(NGO),Harbu MFI is aims at promoting agricultural productivitie and matketing by facilitating value chain development and access to fianacial service to urban and rural community.harbu MFI has counted Many years of opration since its inception in Feb.2005.Harbu is Matured MFI oprating in the industry. Likwise, harbu is catagorized unde Large MFI in terms of its scale of opration</p>

</div>

<div class="Mission">
<h1>Our Mission</h1>
		 		<p>Harbu’s mission is “exists to serve the unbanked and under served target like rural farmers,Womens middle missed group and unemployeed youth by Providing timely , reliable quality, affordable as well as friendly financial product & service in change thier livelihood and thier by contribute towards the national economic development”.</p>

<img  width="100%" height="100%" src="Img/Mission.PNG">
...
<div class="vision">
<h1>Our Vission</h1>
		<p >Harbu’s Vision is “be coming one of the leading private financial inclusive Institution in Ethiopia where its presence reach the unbanked and under served segment of the community/society”.</p>

<img  width="100%" height="100%" src="Img/vision.JPG">
...
<div class="value">
	<h2>value</h2>
		...
		<li>Readness For Change</li>
		<li>Team Work</li>
		<li>technogy frindly</li>
		<li>Respect And Comply with the rul,integrity </li>
